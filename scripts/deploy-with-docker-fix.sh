...
create_env_file() {
    ...
    POOL_ID=${POOL_ID:-"0xdcb7fb4f33aec4a3a9708e1634e53c30ba51d01fd78bd04693a11d5a02c0cd52"}
    SHILL_TOKEN_ADDRESS=${SHILL_TOKEN_ADDRESS:-"0x652159c7f62e9c1613476ca600f3b591dbfc920e"}
    DAO_CONTRACT_ADDRESS=${DAO_CONTRACT_ADDRESS:-"0xE5FE82ec6482d0291f22B5269eDBC4a046eEA763"}
    TRANSFER_EVENT_SIGNATURE=${TRANSFER_EVENT_SIGNATURE:-"0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"}
